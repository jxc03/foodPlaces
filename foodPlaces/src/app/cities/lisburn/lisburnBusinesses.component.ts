/**
 * Code file to display all the businesses from JSON data or API for Derry
 */
...
/**
 * Component that handles the display and management of Derry business listings
 * Provides filtering, sorting, and pagination functionality for business data
 */
@Component({
  selector: 'lisburnBusinesses',
  imports: [RouterOutlet, RouterModule, CommonModule, FormsModule],
  providers: [/*DataService*/ WebService],
  templateUrl: './lisburnBusinesses.component.html',
  styleUrls: ['./lisburnBusinesses.component.css']
})

/**
 * Component that manages the display of businesses in Derry
 ...
 */
export class LisburnBusinessesComponent {
  // Lists
  ...
  /** MongoDB ID for Lisburn city */
  cityId: string = '67267637aeb441ea7afa280d';
  ...
  deletePlace(placeId: string, event: Event) {
    ...
    if (confirm('Are you sure you want to delete this place?')) {  // If user clicks on button then show message
